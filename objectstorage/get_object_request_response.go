...
type GetObjectRequest struct {
	...
	// Optional byte range to fetch, as described in https://tools.ietf.org/rfc/rfc7233, section 2.1.
...
type GetObjectResponse struct {
	...
	// Content-Range header for range requests, per https://tools.ietf.org/rfc/rfc7233, section 4.2.
	ContentRange *string `presentIn:"header" name:"content-range"`

	// Content-MD5 header, as described in https://tools.ietf.org/rfc/rfc2616, section 14.15.
	...
	// Content-Type header, as described in https://tools.ietf.org/rfc/rfc2616, section 14.17.
	ContentType *string `presentIn:"header" name:"content-type"`

	// Content-Language header, as described in https://tools.ietf.org/rfc/rfc2616, section 14.12.
	ContentLanguage *string `presentIn:"header" name:"content-language"`

	// Content-Encoding header, as described in https://tools.ietf.org/rfc/rfc2616, section 14.11.
	ContentEncoding *string `presentIn:"header" name:"content-encoding"`

	// The object modification time, as described in https://tools.ietf.org/rfc/rfc2616, section 14.29.
