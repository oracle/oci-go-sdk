...
func (client ComputeClient) DeleteConsoleHistory(ctx context.Context, request DeleteConsoleHistoryRequest, options ...common.RetryPolicyOption) (response DeleteConsoleHistoryResponse, err error) {
...
func (client ComputeClient) DeleteImage(ctx context.Context, request DeleteImageRequest, options ...common.RetryPolicyOption) (response DeleteImageResponse, err error) {
...
func (client ComputeClient) DeleteInstanceConsoleConnection(ctx context.Context, request DeleteInstanceConsoleConnectionRequest, options ...common.RetryPolicyOption) (response DeleteInstanceConsoleConnectionResponse, err error) {
...
func (client ComputeClient) DetachBootVolume(ctx context.Context, request DetachBootVolumeRequest, options ...common.RetryPolicyOption) (response DetachBootVolumeResponse, err error) {
...
// will be dropped.
func (client ComputeClient) DetachVnic(ctx context.Context, request DetachVnicRequest, options ...common.RetryPolicyOption) (response DetachVnicResponse, err error) {
...
// This is an asynchronous operation. The attachment's `lifecycleState` will change to DETACHING temporarily
// until the attachment is completely removed.
func (client ComputeClient) DetachVolume(ctx context.Context, request DetachVolumeRequest, options ...common.RetryPolicyOption) (response DetachVolumeResponse, err error) {
...
func (client ComputeClient) TerminateInstance(ctx context.Context, request TerminateInstanceRequest, options ...common.RetryPolicyOption) (response TerminateInstanceResponse, err error) {
