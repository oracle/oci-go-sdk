...
func (request ListVolumeAttachmentsRequest) GetHttpRequest(method, path string) (http.Request, error) {
...
func (response ListVolumeAttachmentsResponse) GetRawResponse() *http.Response {
