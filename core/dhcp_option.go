...
// DhcpOption A single DHCP option according to (https://tools.ietf.org/html/rfc1533).
// The two options available to use are DhcpDnsOption
// and DhcpSearchDomainOption. For more
// information, see https://docs.us-phoenix-1.oraclecloud.com/Content/Network/Concepts/dns.htm
// and https://docs.us-phoenix-1.oraclecloud.com/Content/Network/Tasks/managingDHCP.htm.
