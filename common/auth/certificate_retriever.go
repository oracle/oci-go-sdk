...
func newURLBasedX509CertificateRetriever(authClient *common.BaseClient, certURL, privateKeyURL, passphrase string) x509CertificateRetriever {
...
func (r *urlBasedX509CertificateRetriever) renewCertificate(url string) (certificatePemRaw []byte, certificate *x509.Certificate, err error) {
	...
	if body, err = httpGet(r.authClient, url); err != nil {
