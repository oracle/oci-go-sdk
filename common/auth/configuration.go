...
//InstancePrincipalConfigurationProviderWithCustomClient returns a configuration for instance principals using a modifier function to adjust BaseClient settings
func InstancePrincipalConfigurationProviderWithCustomClient(modifier func(*common.BaseClient) (*common.BaseClient, error)) (common.ConfigurationProvider, error) {
	return newInstancePrincipalConfigurationProvider("", modifier)
}

//InstancePrincipalConfigurationForRegionWithCustomClient returns a configuration for instance principals with a given region using a modifier function to adjust BaseClient settings
func InstancePrincipalConfigurationForRegionWithCustomClient(region common.Region, modifier func(*common.BaseClient) (*common.BaseClient, error)) (common.ConfigurationProvider, error) {
	return newInstancePrincipalConfigurationProvider(region, modifier)
}

func newInstancePrincipalConfigurationProvider(region common.Region, modifier func(*common.BaseClient) (*common.BaseClient, error)) (common.ConfigurationProvider, error) {
	var err error
...
func InstancePrincipalConfigurationWithCerts(region common.Region, leafCertificate, leafPassphrase, leafPrivateKey []byte, intermediateCertificates [][]byte) (common.ConfigurationProvider, error) {
	...
	fedClient, err := newX509FederationClientWithCerts(tenancyID, leafCertificate, leafPassphrase, leafPrivateKey, intermediateCertificates, common.NewClientModifier(nil))
	if err != nil {
		return nil, err
	}
