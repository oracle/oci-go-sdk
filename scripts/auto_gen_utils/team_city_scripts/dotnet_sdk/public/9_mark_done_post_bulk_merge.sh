...
python ./5_mark_preview_tickets_done_post_merge.py --build-id $BUILD_ID --tool DotNetSDK --full-version $FULL_VERSION --allow-transition-overall-issue-to-deploy --build-conf-name Sdk_DotNetSdk_BuildDotNetSdkMaster
