...
FULL_VERSION=`cat ../sdk-client-test-data/release-version.txt`
python ./5_mark_preview_tickets_done_post_merge.py --build-id $BUILD_ID --tool TestDataGen --full-version $FULL_VERSION --allow-transition-overall-issue-to-done --build-conf-name Sdk_SdkTestDataAndExamples_GenerateSdkExamplesPreview
