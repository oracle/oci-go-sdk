...
python ./5_mark_preview_tickets_done_post_merge.py --build-id $BUILD_ID --tool RubySDK --full-version $FULL_VERSION --allow-transition-overall-issue-to-done --build-conf-name Sdk_RubySdk_BuildPreviewGemAndDocs
