...
#
parser = argparse.ArgumentParser(description='Check out the source branch, as indicated in the PR. Warning: this is destructive to the contents in the Legacy Java SDK directory.')
...
pr = get_pullrequest("SDK", "legacy-java-sdk", pr_id)
printv(pr.text)

try:
    repo = Repo.init(legacy_java_sdk_dir)
