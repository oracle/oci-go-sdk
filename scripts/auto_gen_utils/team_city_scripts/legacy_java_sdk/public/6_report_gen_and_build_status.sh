...
cd autogen
python ./3_report_generation_status.py --build-id $BUILD_ID --tool LegacyJavaSDK $BUILD_TYPE_ARG --optional-file-for-dexreq-ticket ../specvalidator.txt
cd ..

ls -la ./legacy-java-sdk
