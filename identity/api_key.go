...
// in the required PEM format, see https://docs.us-phoenix-1.oraclecloud.com/Content/API/Concepts/apisigningkey.htm.
// **Important:** This is **not** the SSH key for accessing compute instances.
// Each user can have a maximum of three API signing keys.
// For more information about user credentials, see https://docs.us-phoenix-1.oraclecloud.com/Content/Identity/Concepts/usercredentials.htm.
type ApiKey struct {
