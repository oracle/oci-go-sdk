...
func (client IdentityClient) PollApiKeyUntil(ctx context.Context, request ListApiKeysRequest, predicate func(ListApiKeysResponse, error) bool, options ...oci_common.Option) error {
...
func (client IdentityClient) PollCompartmentUntil(ctx context.Context, request GetCompartmentRequest, predicate func(GetCompartmentResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client IdentityClient) PollCustomerSecretKeySummaryUntil(ctx context.Context, request ListCustomerSecretKeysRequest, predicate func(ListCustomerSecretKeysResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client IdentityClient) PollGroupUntil(ctx context.Context, request GetGroupRequest, predicate func(GetGroupResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client IdentityClient) PollIdentityProviderUntil(ctx context.Context, request GetIdentityProviderRequest, predicate func(GetIdentityProviderResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client IdentityClient) PollIdpGroupMappingUntil(ctx context.Context, request GetIdpGroupMappingRequest, predicate func(GetIdpGroupMappingResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client IdentityClient) PollPolicyUntil(ctx context.Context, request GetPolicyRequest, predicate func(GetPolicyResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client IdentityClient) PollRegionSubscriptionUntil(ctx context.Context, request ListRegionSubscriptionsRequest, predicate func(ListRegionSubscriptionsResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client IdentityClient) PollSwiftPasswordUntil(ctx context.Context, request ListSwiftPasswordsRequest, predicate func(ListSwiftPasswordsResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client IdentityClient) PollUserUntil(ctx context.Context, request GetUserRequest, predicate func(GetUserResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client IdentityClient) PollUserGroupMembershipUntil(ctx context.Context, request GetUserGroupMembershipRequest, predicate func(GetUserGroupMembershipResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
