...
func TestVirtualNetworkClient_BulkAddVirtualCircuitPublicPrefixes(t *testing.T) {
	...
	err := c.BulkAddVirtualCircuitPublicPrefixes(context.Background(), request)
	assert.NoError(t, err)
	return
}

func TestVirtualNetworkClient_BulkDeleteVirtualCircuitPublicPrefixes(t *testing.T) {
	t.Skip("Not implemented")
	c := core.NewVirtualNetworkClientForRegion(testRegionForVirtualNetwork)
	request := core.BulkDeleteVirtualCircuitPublicPrefixesRequest{}
	err := c.BulkDeleteVirtualCircuitPublicPrefixes(context.Background(), request)
	assert.NoError(t, err)
	return
}

func TestVirtualNetworkClient_ConnectLocalPeeringGateways(t *testing.T) {
	t.Skip("Not implemented")
	c := core.NewVirtualNetworkClientForRegion(testRegionForVirtualNetwork)
	request := core.ConnectLocalPeeringGatewaysRequest{}
	err := c.ConnectLocalPeeringGateways(context.Background(), request)
	assert.NoError(t, err)
	return
}
...
func TestVirtualNetworkClient_CreateLocalPeeringGateway(t *testing.T) {
	t.Skip("Not implemented")
	c := core.NewVirtualNetworkClientForRegion(testRegionForVirtualNetwork)
	request := core.CreateLocalPeeringGatewayRequest{}
	r, err := c.CreateLocalPeeringGateway(context.Background(), request)
	assert.NotEmpty(t, r, fmt.Sprint(r))
	assert.NoError(t, err)
	return
}
...
func TestVirtualNetworkClient_DeleteLocalPeeringGateway(t *testing.T) {
	t.Skip("Not implemented")
	c := core.NewVirtualNetworkClientForRegion(testRegionForVirtualNetwork)
	request := core.DeleteLocalPeeringGatewayRequest{}
	err := c.DeleteLocalPeeringGateway(context.Background(), request)
	assert.NoError(t, err)
	return
}
...
func TestVirtualNetworkClient_ListLocalPeeringGateways(t *testing.T) {
	t.Skip("Not implemented")
	c := core.NewVirtualNetworkClientForRegion(testRegionForVirtualNetwork)
	request := core.ListLocalPeeringGatewaysRequest{}
	r, err := c.ListLocalPeeringGateways(context.Background(), request)
	assert.NotEmpty(t, r, fmt.Sprint(r))
	assert.NoError(t, err)
	return
}
...
func TestVirtualNetworkClient_ListVirtualCircuitPublicPrefixes(t *testing.T) {
	t.Skip("Not implemented")
	c := core.NewVirtualNetworkClientForRegion(testRegionForVirtualNetwork)
	request := core.ListVirtualCircuitPublicPrefixesRequest{}
	r, err := c.ListVirtualCircuitPublicPrefixes(context.Background(), request)
	assert.NotEmpty(t, r, fmt.Sprint(r))
	assert.NoError(t, err)
	return
}
...
func TestVirtualNetworkClient_UpdateLocalPeeringGateway(t *testing.T) {
	t.Skip("Not implemented")
	c := core.NewVirtualNetworkClientForRegion(testRegionForVirtualNetwork)
	request := core.UpdateLocalPeeringGatewayRequest{}
	r, err := c.UpdateLocalPeeringGateway(context.Background(), request)
	assert.NotEmpty(t, r, fmt.Sprint(r))
	assert.NoError(t, err)
	return
}
