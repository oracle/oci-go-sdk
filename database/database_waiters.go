...
func (client DatabaseClient) PollBackupUntil(ctx context.Context, request GetBackupRequest, predicate func(GetBackupResponse, error) bool, options ...oci_common.Option) error {
...
func (client DatabaseClient) PollBackupSummaryUntil(ctx context.Context, request ListBackupsRequest, predicate func(ListBackupsResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client DatabaseClient) PollDataGuardAssociationUntil(ctx context.Context, request GetDataGuardAssociationRequest, predicate func(GetDataGuardAssociationResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client DatabaseClient) PollDataGuardAssociationSummaryUntil(ctx context.Context, request ListDataGuardAssociationsRequest, predicate func(ListDataGuardAssociationsResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client DatabaseClient) PollDatabaseUntil(ctx context.Context, request GetDatabaseRequest, predicate func(GetDatabaseResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client DatabaseClient) PollDatabaseSummaryUntil(ctx context.Context, request ListDatabasesRequest, predicate func(ListDatabasesResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client DatabaseClient) PollDbHomeUntil(ctx context.Context, request GetDbHomeRequest, predicate func(GetDbHomeResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client DatabaseClient) PollDbHomeSummaryUntil(ctx context.Context, request ListDbHomesRequest, predicate func(ListDbHomesResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client DatabaseClient) PollDbNodeUntil(ctx context.Context, request GetDbNodeRequest, predicate func(GetDbNodeResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client DatabaseClient) PollDbNodeSummaryUntil(ctx context.Context, request ListDbNodesRequest, predicate func(ListDbNodesResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client DatabaseClient) PollDbSystemUntil(ctx context.Context, request GetDbSystemRequest, predicate func(GetDbSystemResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client DatabaseClient) PollDbSystemSummaryUntil(ctx context.Context, request ListDbSystemsRequest, predicate func(ListDbSystemsResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client DatabaseClient) PollPatchUntil(ctx context.Context, request GetDbHomePatchRequest, predicate func(GetDbHomePatchResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client DatabaseClient) PollPatchHistoryEntryUntil(ctx context.Context, request GetDbHomePatchHistoryEntryRequest, predicate func(GetDbHomePatchHistoryEntryResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client DatabaseClient) PollPatchHistoryEntrySummaryUntil(ctx context.Context, request ListDbHomePatchHistoryEntriesRequest, predicate func(ListDbHomePatchHistoryEntriesResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client DatabaseClient) PollPatchSummaryUntil(ctx context.Context, request ListDbHomePatchesRequest, predicate func(ListDbHomePatchesResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
