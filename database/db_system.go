...
type DbSystem struct {
	...
	DiskRedundancy DbSystemDiskRedundancyEnum `mandatory:"false" json:"diskRedundancy" omitEmpty:"true"`
	...
	LicenseModel DbSystemLicenseModelEnum `mandatory:"false" json:"licenseModel" omitEmpty:"true"`
