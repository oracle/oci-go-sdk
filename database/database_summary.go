...
// DatabaseSummary An Oracle database on a DB System. For more information, see https://docs.us-phoenix-1.oraclecloud.com/Content/Database/Concepts/overview.htm.
