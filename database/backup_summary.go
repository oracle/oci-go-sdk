...
type BackupSummary struct {
	...
	LifecycleState BackupSummaryLifecycleStateEnum `mandatory:"false" json:"lifecycleState" omitEmpty:"true"`
	...
	// The type of backup.
	Type BackupSummaryTypeEnum `mandatory:"false" json:"type" omitEmpty:"true"`
}
