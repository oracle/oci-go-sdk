...
func (request GetDatabaseRequest) GetHttpRequest(method, path string) (http.Request, error) {
...
func (response GetDatabaseResponse) GetRawResponse() *http.Response {
	return response.RawResponse
}

// GetStatefulEntity implements the OciStatefulResponse interface
func (response GetDatabaseResponse) GetStatefulEntity() common.OciPollable {
