...
type Backup struct {
	...
	LifecycleState BackupLifecycleStateEnum `mandatory:"false" json:"lifecycleState" omitEmpty:"true"`
	...
	// The type of backup.
	Type BackupTypeEnum `mandatory:"false" json:"type" omitEmpty:"true"`
}
