...
func (request GetDataGuardAssociationRequest) GetHttpRequest(method, path string) (http.Request, error) {
...
func (response GetDataGuardAssociationResponse) GetRawResponse() *http.Response {
	return response.RawResponse
}

// GetStatefulEntity implements the OciStatefulResponse interface
func (response GetDataGuardAssociationResponse) GetStatefulEntity() common.OciPollable {
