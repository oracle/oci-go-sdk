...
func (client DomainGovernanceClient) createDomainGovernance(ctx context.Context, request common.OCIRequest) (common.OCIResponse, error) {
	httpRequest, err := request.HTTPRequest(http.MethodPost, "/domainGovernances")
	if err != nil {
		return nil, err
	}
...
func (client DomainGovernanceClient) deleteDomainGovernance(ctx context.Context, request common.OCIRequest) (common.OCIResponse, error) {
	httpRequest, err := request.HTTPRequest(http.MethodDelete, "/domainGovernances/{domainGovernanceId}")
	if err != nil {
		return nil, err
	}
...
func (client DomainGovernanceClient) getDomainGovernance(ctx context.Context, request common.OCIRequest) (common.OCIResponse, error) {
	httpRequest, err := request.HTTPRequest(http.MethodGet, "/domainGovernances/{domainGovernanceId}")
	if err != nil {
		return nil, err
	}
...
func (client DomainGovernanceClient) listDomainGovernances(ctx context.Context, request common.OCIRequest) (common.OCIResponse, error) {
	httpRequest, err := request.HTTPRequest(http.MethodGet, "/domainGovernances")
	if err != nil {
		return nil, err
	}
...
func (client DomainGovernanceClient) updateDomainGovernance(ctx context.Context, request common.OCIRequest) (common.OCIResponse, error) {
	httpRequest, err := request.HTTPRequest(http.MethodPut, "/domainGovernances/{domainGovernanceId}")
	if err != nil {
		return nil, err
	}
