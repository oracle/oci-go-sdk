...
// # See also
//
// Click https://docs.cloud.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/marketplacepublisher/CreateOffer.go.html to see an example of how to use CreateOffer API.
...
// # See also
//
// Click https://docs.cloud.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/marketplacepublisher/DeleteOffer.go.html to see an example of how to use DeleteOffer API.
...
// # See also
//
// Click https://docs.cloud.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/marketplacepublisher/GetOffer.go.html to see an example of how to use GetOffer API.
...
// # See also
//
// Click https://docs.cloud.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/marketplacepublisher/GetOfferInternalDetail.go.html to see an example of how to use GetOfferInternalDetail API.
...
// # See also
//
// Click https://docs.cloud.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/marketplacepublisher/ListOffers.go.html to see an example of how to use ListOffers API.
...
// # See also
//
// Click https://docs.cloud.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/marketplacepublisher/UpdateOffer.go.html to see an example of how to use UpdateOffer API.
