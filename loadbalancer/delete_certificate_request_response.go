...
type DeleteCertificateRequest struct {
	...
	// The https://docs.us-phoenix-1.oraclecloud.com/Content/General/Concepts/identifiers.htm of the load balancer associated with the certificate to be deleted.
