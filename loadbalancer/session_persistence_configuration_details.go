...
// For more information, see https://docs.us-phoenix-1.oraclecloud.com/Content/Balance/Reference/sessionpersistence.htm.
...
type SessionPersistenceConfigurationDetails struct {
	...
	CookieName *string `mandatory:"true" json:"cookieName,omitempty"`
