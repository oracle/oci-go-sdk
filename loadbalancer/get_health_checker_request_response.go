...
type GetHealthCheckerRequest struct {
	...
	// The https://docs.us-phoenix-1.oraclecloud.com/Content/General/Concepts/identifiers.htm of the load balancer associated with the health check policy to be retrieved.
