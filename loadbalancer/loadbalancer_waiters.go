...
func (client LoadBalancerClient) PollBackendHealthUntil(ctx context.Context, request GetBackendHealthRequest, predicate func(GetBackendHealthResponse, error) bool, options ...oci_common.Option) error {
...
func (client LoadBalancerClient) PollBackendSetHealthUntil(ctx context.Context, request GetBackendSetHealthRequest, predicate func(GetBackendSetHealthResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client LoadBalancerClient) PollLoadBalancerUntil(ctx context.Context, request GetLoadBalancerRequest, predicate func(GetLoadBalancerResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client LoadBalancerClient) PollLoadBalancerHealthUntil(ctx context.Context, request GetLoadBalancerHealthRequest, predicate func(GetLoadBalancerHealthResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client LoadBalancerClient) PollLoadBalancerHealthSummaryUntil(ctx context.Context, request ListLoadBalancerHealthsRequest, predicate func(ListLoadBalancerHealthsResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
...
func (client LoadBalancerClient) PollWorkRequestUntil(ctx context.Context, request GetWorkRequestRequest, predicate func(GetWorkRequestResponse, error) bool, options ...oci_common.Option) error {
	policy := oci_common.BuildRetryPolicy(options...)
	deadlineContext, deadlineCancel := context.WithTimeout(ctx, oci_common.GetMaximumTimeout(policy))
	defer deadlineCancel()
