...
func (request CreateListenerRequest) GetHttpRequest(method, path string) (http.Request, error) {
...
func (response CreateListenerResponse) GetRawResponse() *http.Response {
