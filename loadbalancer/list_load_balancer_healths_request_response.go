...
type ListLoadBalancerHealthsRequest struct {
	...
	// The https://docs.us-phoenix-1.oraclecloud.com/Content/General/Concepts/identifiers.htm of the compartment containing the load balancers to return health status information for.
